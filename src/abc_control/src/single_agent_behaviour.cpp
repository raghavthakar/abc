#include "ros/ros.h"
#include "abc_control/MoveDistance.h"
...
int main(int argc, char **argv)
{
  ...
  ros::init(argc, argv, "single_agent_behaviour");
  ros::NodeHandle n;

  ros::ServiceClient client = n.serviceClient
                    <abc_control::MoveDistance>(move_distance_service_name);

  //Instantiate the service class
  abc_control::MoveDistance srv;
